...
##################
    ...
    observers = np.array(((-3,-3,-3),(3,-3,-3),(-3,3,-3),(3,3,-3),(-3,-3,3),(3,-3,3),(-3,3,3),(3,3,3)))
    ...
    res = derivative(getPhi, observers, (dimensions, polarizations, positions), eps=1e-3)
    Bx = -res[0]
    By = -res[1]
    Bz = -res[2]
...
###############
    ...
    for i in range(len(dimensions)):
        ...
        print(magnet.getB(observers))
        print(magnet.getH(observers)*4*np.pi/10)